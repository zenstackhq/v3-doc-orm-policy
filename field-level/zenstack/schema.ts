        ...
        Post: {
            ...
            fields: {
                ...
                title: {
                    name: "title",
                    type: "String",
                    attributes: [{ name: "@allow", args: [{ name: "operation", value: ExpressionUtils.literal("read") }, { name: "condition", value: ExpressionUtils.field("published") }] }, { name: "@allow", args: [{ name: "operation", value: ExpressionUtils.literal("update") }, { name: "condition", value: ExpressionUtils.binary(ExpressionUtils.call("auth"), "==", ExpressionUtils.field("author")) }] }]
                },
                published: {
                    name: "published",
                    type: "Boolean",
